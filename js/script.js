window.addEventListener('DOMContentLoaded', () => {
    ...
    function createElement(arr) {
        ...
        arr.forEach(function(item) {
            let card = document.createElement('div');  //создать элемент, обычный блок
            card.classList.add('goods__item');  //добавялем в него новый класс гудс айтем
            card.innerHTML = `
...
// const example = {username: "Bulat"};


// fetch('https://jsonplaceholder.typicode.com/posts',
//             {
//                 method: "POST",    //отправка в БД
//                 body: JSON.stringify(example) //объект для отправки
//             })  //promice
//   .then(response => response.json())
